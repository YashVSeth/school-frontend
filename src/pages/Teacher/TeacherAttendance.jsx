...
const TeacherAttendance = () => {
  ...
  const fetchStudents = async () => {
    try {
      ...
      // Shuru mein sabka status "Pending" ya empty rakhein
      const initialStatus = {};
      res.data.students.forEach(s => initialStatus[s._id] = null);
        ...
        {students.map((student) => (
          <div 
            ...
            className={`p-4 rounded-xl border flex flex-col sm:flex-row items-center justify-between gap-4 transition-all ${
                attendance[student._id] === 'Absent' ? 'bg-red-50 border-red-100' : 
          ...
          >
            ...
            <div className="flex gap-2 w-full sm:w-auto justify-center">
                <button 
                    ...
                    className={`flex-1 sm:flex-none px-4 py-2 rounded-lg font-bold flex items-center gap-2 border transition ${
