...
const PromoteClassModal = ({ isOpen, onClose, classes, refreshData, defaultClassId }) => {
  ...
  const handleBulkPromote = async () => {
    ...
    // Find Class Names for confirmation
        ...
        <div className="p-8 space-y-8">
            ...
            <div className="flex-1 space-y-2">
                ...
                <div className="p-4 rounded-xl border-2 border-slate-200 bg-white hover:border-violet-400 transition-colors">
                    ...
                    >
                        ...
                        {classes
                            .filter(c => c._id !== fromClass) // Hide same class
          ...
          <div className="bg-blue-50 p-4 rounded-xl flex gap-3 items-start">
             ...
             <div>
                ...
                <p className="text-xs text-blue-700 mt-1">All active students in the "From" class will be instantly updated to the "To" class.</p>
             </div>
          </div>
